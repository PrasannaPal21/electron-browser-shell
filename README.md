...
| [`chrome.extension`](https://developer.chrome.com/docs/extensions/reference/extension/) | Best-effort `getViews` via IPC metadata (`id`, `type`, `windowId`, `tabId`, `url`) with popup-context fallback for common checks. |
